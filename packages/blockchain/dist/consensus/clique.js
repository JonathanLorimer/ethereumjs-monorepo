...
exports.CliqueConsensus = exports.CLIQUE_NONCE_DROP = exports.CLIQUE_NONCE_AUTH = void 0;
...
class CliqueConsensus {
    ...
    async cliqueUpdateSignerStates(signerState) {
        ...
        await this.blockchain.db.put(CLIQUE_SIGNERS_KEY, Buffer.from(rlp_1.default.encode((0, util_1.bufArrToArr)(formatted))), DB_OPTS);
    ...
    async cliqueUpdateVotes(header) {
        ...
        await this.blockchain.db.put(CLIQUE_VOTES_KEY, Buffer.from(rlp_1.default.encode((0, util_1.bufArrToArr)(formatted))), DB_OPTS);
    }
    /**
    ...
    async cliqueUpdateLatestBlockSigners(header) {
        ...
        await this.blockchain.db.put(CLIQUE_BLOCK_SIGNERS_SNAPSHOT_KEY, Buffer.from(rlp_1.default.encode((0, util_1.bufArrToArr)(formatted))), DB_OPTS);
    }
    /**
    ...
    async getCliqueLatestSignerStates() {
        try {
            ...
            const states = (0, util_1.arrToBufArr)(rlp_1.default.decode(Uint8Array.from(signerStates)));
    ...
    async getCliqueLatestVotes() {
        try {
            ...
            const votes = (0, util_1.arrToBufArr)(rlp_1.default.decode(Uint8Array.from(signerVotes)));
    ...
    async getCliqueLatestBlockSigners() {
        try {
            ...
            const signers = (0, util_1.arrToBufArr)(rlp_1.default.decode(Uint8Array.from(blockSigners)));
