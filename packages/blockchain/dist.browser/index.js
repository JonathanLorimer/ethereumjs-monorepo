    ...
    constructor(opts = {}) {
        ...
        switch (this._common.consensusAlgorithm()) {
            case common_1.ConsensusAlgorithm.Casper:
                this.consensus = new consensus_1.CasperConsensus({ blockchain: this });
                break;
            case common_1.ConsensusAlgorithm.Clique:
                this.consensus = new consensus_1.CliqueConsensus({ blockchain: this });
                break;
            case common_1.ConsensusAlgorithm.Ethash:
                this.consensus = new consensus_1.EthashConsensus({ blockchain: this });
                break;
            default:
