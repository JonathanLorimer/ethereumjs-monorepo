...
class Account {
    ...
    static fromAccountData(accountData) {
        ...
        return new Account(nonce ? (0, bytes_1.bufferToBigInt)((0, bytes_1.toBuffer)(nonce)) : undefined, balance ? (0, bytes_1.bufferToBigInt)((0, bytes_1.toBuffer)(balance)) : undefined, stateRoot ? (0, bytes_1.toBuffer)(stateRoot) : undefined, codeHash ? (0, bytes_1.toBuffer)(codeHash) : undefined);
    }
    static fromRlpSerializedAccount(serialized) {
        const values = (0, bytes_1.arrToBufArr)(rlp_1.default.decode(Uint8Array.from(serialized)));
     ...
     */
    serialize() {
        return Buffer.from(rlp_1.default.encode((0, bytes_1.bufArrToArr)(this.raw())));
    }
    /**
...
const generateAddress = function (from, nonce) {
    ...
    if ((0, bytes_1.bufferToBigInt)(nonce) === BigInt(0)) {
        ...
        return Buffer.from((0, keccak_1.keccak256)(rlp_1.default.encode((0, bytes_1.bufArrToArr)([from, null])))).slice(-20);
    }
    // Only take the lower 160bits of the hash
    return Buffer.from((0, keccak_1.keccak256)(rlp_1.default.encode((0, bytes_1.bufArrToArr)([from, nonce])))).slice(-20);
};
