...
const ropsten_json_1 = __importDefault(require("./chains/ropsten.json"));
const rinkeby_json_1 = __importDefault(require("./chains/rinkeby.json"));
const kovan_json_1 = __importDefault(require("./chains/kovan.json"));
