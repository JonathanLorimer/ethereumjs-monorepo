...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState, common) {
            ...
            const r = (0, _1.exponentation)(base, exponent);
            runState.stack.push(r);
        },
    ],
    // 0x0b: SIGNEXTEND
    ...
    [
        0x30,
        function (runState) {
            const address = (0, util_1.bufferToBigInt)(runState.eei.getAddress().buf);
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_2.getDataSlice)(runState.eei.getCallData(), dataOffset, dataLength);
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_2.getDataSlice)(runState.eei.getCode(), codeOffset, dataLength);
                const memOffsetNum = Number(memOffset);
    ...
    [
        ...
        async function (runState) {
            ...
            const code = await runState.eei.getExternalCode(addressBigInt);
            if (code.length === 0) {
                runState.stack.push((0, util_1.bufferToBigInt)(util_1.KECCAK256_NULL));
                return;
            }
            runState.stack.push(BigInt('0x' + (0, utils_1.bytesToHex)((0, keccak_1.keccak256)(code))));
        },
    ],
    // 0x3d: RETURNDATASIZE
    [
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_2.getDataSlice)(runState.eei.getReturnData(), returnDataOffset, dataLength);
                const memOffsetNum = Number(memOffset);
                const lengthNum = Number(dataLength);
                runState.memory.extend(memOffsetNum, lengthNum);
                runState.memory.write(memOffsetNum, lengthNum, data);
    ...
    [
        ...
        function (runState) {
            ...
            const loaded = (0, util_1.bufferToBigInt)(runState.eei.getCode().slice(runState.programCounter, runState.programCounter + numToPush));
    ...
    [
        ...
        async function (runState) {
            ...
            const ret = await runState.eei.create2(gasLimit, value, data, (0, util_1.setLengthLeft)((0, util_1.bigIntToBuffer)(salt), 32));
            runState.stack.push(ret);
        },
    ],
    // 0xf1: CALL
    ...
    [
        ...
        async function (runState) {
            ...
            const paddedInvokerAddress = (0, util_1.setLengthLeft)(runState.eei._env.address.buf, 32);
            const chainId = (0, util_1.setLengthLeft)((0, util_1.bigIntToBuffer)(runState.eei.getChainId()), 32);
